  ...
  <div class="container" style="width: 100%;">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <?php } ?>
        <?php if(isset($_SESSION["email"]) && $filas['rol'] == 1){ ?>
        <li><a href="#" title="Stock"><i class="material-icons">assignment_turned_in</i></a></li>
        <?php } ?>
...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
  ...
  //la variable  $mysqli viene de connect_db que lo traigo con el require("connect_db.php");
    ...
    ?>
    <form action="ejecactusr.php" method="post">
        
        Correo usuario<br> <input type="text" name="email" value="<?php echo $con[4] ?>"><br>
        Password <br> <input type="text" name="pass" value="<?php echo $con[3] ?>"><br>
        Telefono <br> <input type="text" name="tel" maxlength="11" value="<?php echo $con[2] ?>"><br>
        RFC <br> <input type="text" name="rfc" value="<?php echo $con[1] ?>"><br>
        Direccion <br> <input type="text" name="dir"  value="<?php echo $con[5] ?>"><br>
